...
static void AddRoundKey(uint8_t round, uint8_t RoundKey[176], uint8_t state[4][4])
{
  uint8_t i,j;
  for(i=0;i<4;i++)
  {
...
static void Cipher(uint8_t RoundKey[176], uint8_t *in, uint8_t *out, uint8_t state[4][4])
{
  uint8_t i, j, round = 0;
...
static void InvCipher(uint8_t RoundKey[176], uint8_t *in, uint8_t *out, uint8_t state[4][4])
{
  uint8_t i,j,round=0;
...
void AES128_ECB_encrypt(uint8_t* input, const uint8_t* key, uint8_t *output)
{
  ...
  Cipher(RoundKey, input, output, state);
}
...
void AES128_ECB_decrypt(uint8_t* input, const uint8_t* key, uint8_t *output)
{
  ...
  InvCipher(RoundKey, input, output, state);
}
